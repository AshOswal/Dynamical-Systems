function [flag ] = spm_DCM_lifpopsys_LC_adapstep_y_par_PRCa(P,M,Vp)
...
for j = 1:jmax
    ...
    U = 1:NT0;
    t0 = round(j*T0/jmax/mindt)*mindt;
    U = exp((l-2))*exp(-(1/.0005)*(U*mindt-t0)).*(U*mindt > t0);
...
%     end
    save(['PRCa/Mj' num2str(l) '_' num2str(j)], 'Mj')
