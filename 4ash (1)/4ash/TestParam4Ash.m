...
P.P(1).T   = log([10,16,10,16]/1000);   % [s] Decay time constants for the synaptic conductances
...
P.P(2).T   = log([10,16,10,16]/1000);   % [s] Decay time constants for the synaptic conductances
